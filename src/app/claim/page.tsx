...
export default function ClaimPage() {
  return (
    <main className="w-full pt-2 " style={{ background: "var(--background)" }}>
      <section className="bg-[image:var(--gradient-secondary)] mx-10 p-8 rounded-3xl h-[82vh] overflow-y-auto hide-scrollbar py-16 ">
        <div className="flex flex-col gap-10 justify-center items-center h-full">
          ...
          <div
            className="h-full w-11/12 rounded-3xl p-2 bg-[var(--background)]"
            style={{
